...
/**
 * LogmnrIndpartId generated by hbm2java
 */
public class LogmnrIndpartId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LogmnrIndpartId) ) return false;
		 LogmnrIndpartId castOther = ( LogmnrIndpartId ) other; 
 ...
 && ( (this.getBo_()==castOther.getBo_()) || ( this.getBo_()!=null && castOther.getBo_()!=null && this.getBo_().equals(castOther.getBo_()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getBo_() == null ? 0 : this.getBo_().hashCode() );
         return result;
   }   
