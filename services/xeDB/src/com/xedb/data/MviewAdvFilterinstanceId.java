...
/**
 * MviewAdvFilterinstanceId generated by hbm2java
 */
public class MviewAdvFilterinstanceId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MviewAdvFilterinstanceId) ) return false;
		 MviewAdvFilterinstanceId castOther = ( MviewAdvFilterinstanceId ) other; 
 ...
 && ( (this.getFilterid_()==castOther.getFilterid_()) || ( this.getFilterid_()!=null && castOther.getFilterid_()!=null && this.getFilterid_().equals(castOther.getFilterid_()) ) )
