...
/**
 * DefAqcall generated by hbm2java
 */
public class DefAqcall  implements java.io.Serializable {


     private DefAqcallId id;
    ...
    public DefAqcallId getId() {
        return this.id;
    }
    
    public void setId(DefAqcallId id) {
        this.id = id;
    }
