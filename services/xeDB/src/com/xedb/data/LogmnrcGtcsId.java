...
public class LogmnrcGtcsId  implements java.io.Serializable {
 ...
 && ( (this.getObjv_()==castOther.getObjv_()) || ( this.getObjv_()!=null && castOther.getObjv_()!=null && this.getObjv_().equals(castOther.getObjv_()) ) )
 && ( (this.getIntcol_()==castOther.getIntcol_()) || ( this.getIntcol_()!=null && castOther.getIntcol_()!=null && this.getIntcol_().equals(castOther.getIntcol_()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getObjv_() == null ? 0 : this.getObjv_().hashCode() );
